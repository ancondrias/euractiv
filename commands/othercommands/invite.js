...
module.exports = {
  ...
  execute(message){
    ...
    .setURL('https://discord.com/api/oauth2/authorize?client_id=950329706933284904&permissions=3072&scope=bot')
    .setDescription('**For any questions get in touch with:** Høpe#1030');
    //.setImage('https://i.imgur.com/hRIWwz0.png', 'https://discord.com/api/oauth2/authorize?client_id=950329706933284904&permissions=3072&scope=bot')
